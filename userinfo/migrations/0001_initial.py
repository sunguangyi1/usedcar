# -*- coding: utf-8 -*-
# Generated by Django 1.11.8 on 2018-11-14 09:38
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uphone', models.CharField(blank=True, max_length=20, null=True, unique=True, verbose_name='手机号')),
                ('realname', models.CharField(blank=True, max_length=20, null=True, verbose_name='真实姓名')),
                ('uindetity', models.CharField(blank=True, max_length=30, null=True, verbose_name='身份证')),
